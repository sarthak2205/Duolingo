  ...
  return (
    <div className='w-screen h-full p-7 overflow-y-scroll'>
        ...
        <div className=' h-full flex flex-col justify-center items-center  md:-mt-2'>
            <form className='h-full flex flex-col justify-center items-center md:p-2' onSubmit={(e)=>handleSubmit(e)}>
                <div className='text-2xl md:text-3xl font-bold p-4 pb-7 pt-8 mt-2'>
                    <h1 >Log in</h1>
                </div>
                <div className='w-full rounded-2xl mb-3 bg-[#f7f7f7] focus-within:scale-110 transition duration-300 ease-in-out'>
                    <input 
                        ...
                        required="Required"
                        className= 'w-full appearance-none bg-[#f7f7f7] text-gray-800 p-2 rounded-2xl border-2 border-solid border-slate-300 px-5 font-thin lg:py-4 text-base md:text-xl placeholder:font-thin placeholder:text-gray-400 password'/>{error?.userID !== "" && (
                            <BsExclamationLg className="ml-4 h-7 text-alert" />
                          )}
                </div>
