  ...
  return (
    <div className='w-screen h-full p-7 overflow-y-scroll'>
        ...
        <div className=' h-full flex flex-col justify-center items-center  md:-mt-2'>
            <form className='h-full flex flex-col justify-center items-center md:p-2'>
                ...
                <div className='w-full rounded-2xl mb-3 bg-[#f7f7f7] focus-within:scale-110 transition duration-300 ease-in-out'>
                    <input 
                        ...
                        required
                        className= 'w-full bg-[#f7f7f7] text-gray-800 p-2 rounded-2xl border-2 border-solid border-slate-300 px-5 font-thin lg:py-4 text-base md:text-xl placeholder:font-thin placeholder:text-gray-400 password'/>{error?.userID !== ""}
                </div>
